...
Mack <https://www.ohloh.net/accounts/zonque>`_ предложил `механизм фильтрации трафика в зависимости от cgroups, основанный на eBPF <https://www.mail-archive.com/netdev@vger.kernel.org/msg123447.html>`_, что теоретически позволит очень гибко управлять трафиков контейнеров. На этом же уровне реализован SELinux.
