.. title: MPEG-1 и MPEG-2 патентно чисты!
...
Реализации популярных сейчас `MP4 <https://ru.wikipedia.org/wiki/MPEG-4>`_ и его предшественника, `H.263 <https://ru.wikipedia.org/wiki/H.263>`_, пока официально включить в Fedora нельзя. Осталось подождать лет 10-15 - освободятся и они. Когда освободится `HEVC (H.265) <https://ru.wikipedia.org/wiki/H.265>`_, так даже и думать не хочется.
