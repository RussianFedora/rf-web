...
`предлагает третий
вариант <http://thread.gmane.org/gmane.linux.kernel.api/7536>`__.

Коллеги-аналитики уже `обсуждают изменение на
OpenNET.ru <http://www.opennet.ru/opennews/art.shtml?num=41478>`__.
...
udev <http://thread.gmane.org/gmane.linux.drivers.video-input-infrastructure/49987/focus=1368617>`__
за то, что те `решили работать синхронно и не загружать firmware до
полной инициализации модуля
ядра <http://thread.gmane.org/gmane.linux.kernel.wireless.general/83930>`__,
...
udev <http://thread.gmane.org/gmane.linux.gentoo.project/2262>`__, а
...
ядро <http://thread.gmane.org/gmane.linux.kernel/1868124>`__ `Дмитрием
