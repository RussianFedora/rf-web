...
(т.н. `PPA <http://en.wikipedia.org/wiki/Personal_Package_Archive>`__).
...
Fedora `сделана
доступной <http://dummdida.blogspot.ru/2013/05/mozillas-rust-in-fedoras-ppa-copr.html>`__
...
`abi-compliance-checker <http://thread.gmane.org/gmane.linux.redhat.fedora.devel/181746>`__,
...
`поменять свое
назначение <http://thread.gmane.org/gmane.linux.redhat.fedora.security/619>`__.
