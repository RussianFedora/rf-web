.. title: Смена лидера проекта Fedora
...
`ресурсах <http://www.opennet.ru/opennews/art.shtml?num=33020>`__.

Смена лидера проекта в Fedora — дело достаточно
`обычное <http://fedoraproject.org/wiki/FPL>`__. За время существования
русскоязычного проекта Russian Fedora, на запуск которого приезжал `Макс
Спевак (Max Spevack) <http://fedoraproject.org/wiki/MaxSpevack>`__, это
...
совета <http://fedoraproject.org/wiki/Board>`__, состоящего из 9
человек, 5 из которых избираются сообществом.

Теперь в роли лидера `Робин Бергерон (Robyn
Bergeron) <http://fedoraproject.org/wiki/User:Rbergero>`__ — милая
