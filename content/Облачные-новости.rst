...
| `Вышел новый релиз OpenStack под кодовым именем
  "Havana" <http://thread.gmane.org/gmane.comp.cloud.openstack.announce/38>`__.

  Новость уже обсуждается на
  `OpenNET.ru <http://www.opennet.ru/opennews/art.shtml?num=38198>`__.
  ...
  19 <http://fedoraproject.org/wiki/Features/OpenStack_Grizzly>`__ и
...
| Одновременно были объявлены `результаты
  выборов <http://thread.gmane.org/gmane.comp.cloud.openstack.announce/39>`__
  ...
  Asterisk, `Russel Bryant <https://www.ohloh.net/accounts/russellb>`__
  и участника Fedora и уже бывалого участника технического комитета
  OpenStack, `Mark
  McLoughlin <https://www.ohloh.net/accounts/markmc>`__. К сожалению, в
  совет не были выбраны кандидаты из Mirantis - разработчик из Саратова,
  `Sergey Lukjanov <https://www.ohloh.net/accounts/Frostman>`__, и
  ...
  анонсировал <http://thread.gmane.org/gmane.comp.cloud.openstack.devel/6397>`__
  систему нагрузочного тестирования для OpenStack,
  `Rally <https://wiki.openstack.org/wiki/Rally>`__, а Sergey Lukjanov
  `объявил о
  доработке <http://thread.gmane.org/gmane.comp.cloud.openstack.devel/6484>`__
...
| Судорожные и растерянные метания VMware были видны `не только
  ...
  анонсировал <http://thread.gmane.org/gmane.comp.cloud.openstack.devel/6444>`__,
...
| Вообще, численность компаний в коммьюнити OpenStack растет и растет.
  ...
  `SDN <http://ru.wikipedia.org/wiki/Программно-конфигурируемая_сеть>`__
...
| Возвращаясь к OpenStack Havana, одной из важных фич этого релиза
  ...
  `bare-metal <http://ru.wikipedia.org/wiki/Bare_metal>`__! Например
...
| Docker, кстати, тоже сильно выиграл от сотрудничества с Red Hat, о
  ...
  Larsson <https://www.ohloh.net/accounts/alexl>`__, в свое время
  ...
  mapper (`фича Fedora
  17 <http://fedoraproject.org/wiki/Features/ThinProvisioning>`__), и
