...
Инженер Red Hat, `Ben
Skeggs <https://www.ohloh.net/accounts/darktama>`__, добавил `поддержку
...
`OpenNET.ru <http://www.opennet.ru/opennews/art.shtml?num=38384>`__ и
`Linux.org.ru <http://www.linux.org.ru/forum/talks/9796268>`__.
...
Airlie <https://www.ohloh.net/accounts/airlied>`__ недавно `выпустил
версию
1.0.10 <http://thread.gmane.org/gmane.comp.freedesktop.xorg.nouveau/14840>`__.
...
McNamara <http://www.ohloh.net/accounts/caolan>`__, объявил о `полном
переходе с устаревшего класса строк в LibreOffice на
новый <http://caolanm.blogspot.ru/2013/11/unistring.html>`__. В
...
Miracast <http://www.opennet.ru/opennews/art.shtml?num=38353>`__.

Инженер Red Hat и мэйнтейнер libssh, `Andreas
Schneider <https://www.ohloh.net/accounts/asn>`__, обращает наше
...
`Вышел SystemTap
2.4 <http://thread.gmane.org/gmane.linux.kernel/1590886>`__. Из новостей
...
Fedora <http://thread.gmane.org/gmane.linux.redhat.fedora.devel.announce/1197>`__,
и `обновление Python3 до версии
3.4 <http://thread.gmane.org/gmane.linux.redhat.fedora.devel.announce/1196>`__.
...
Новость уже `обсуждается на
Linux.org.ru <http://www.linux.org.ru/news/opensource/9792765>`__
