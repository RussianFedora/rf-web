...
список <http://thread.gmane.org/gmane.linux.redhat.fedora.devel/175937>`__.
...
`самое время
вмешаться <http://fedoraproject.org/wiki/PackageMaintainers/ru/Как_стать_владельцем_пакета>`__.
