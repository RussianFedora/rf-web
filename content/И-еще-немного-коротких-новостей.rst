...
0.8 <https://thread.gmane.org/gmane.linux.kernel.containers/26942>`__ (в
Fedora уже собрана).

Участник Fedora, инженер Red Hat, Karel Zak, `выпустил util-linux версии
2.24 <https://thread.gmane.org/gmane.linux.file-systems/79302>`__.

Наши друзья в Eucaliptus `выпустили версию 3.4 своей одноименной
облачной
системы <https://www.opennet.ru/opennews/art.shtml?num=38268>`__. Из
...
grep 2.15 <https://thread.gmane.org/gmane.org.fsf.announce/2047>`__. В
...
презентации <https://www.slideshare.net/max_posedon/linuxcon-europe-2013>`__.
