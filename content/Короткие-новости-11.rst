...
`объявил <http://thread.gmane.org/gmane.linux.redhat.fedora.core.announce/2905>`__
...
`OpenNET.ru <http://www.opennet.ru/opennews/art.shtml?num=37797>`__.
...
IVI-систем <http://thread.gmane.org/gmane.comp.freedesktop.wayland.devel/10493>`__.
...
KDE `Aaron Seigo <http://www.ohloh.net/accounts/aseigo>`__ в своей ленте
...
вопросы <http://www.opennet.ru/opennews/art.shtml?num=37802>`__
...
Verhaegen <https://www.ohloh.net/accounts/libv>`__, продолжает работу
