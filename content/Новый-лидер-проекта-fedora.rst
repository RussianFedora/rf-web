...
Board <http://fedoraproject.org/wiki/Board>`__ -- команда из 10 человек,
...
(FPL) <http://fedoraproject.org/wiki/Project_Leader>`__ - это штатная
...
Спевака <http://fedoraproject.org/wiki/MaxSpevack>`__. Пользователи
